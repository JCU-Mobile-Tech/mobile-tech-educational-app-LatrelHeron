...
fun LandingScreen(
    ...
    Card ()
    {
        Column( modifier = Modifier.fillMaxWidth().padding(24.dp), horizontalAlignment = Alignment.CenterHorizontally)
        {
            ...
            Spacer(modifier = Modifier.height(8.dp))
            Text( text = "5 Multiplication - 5 Division", fontSize = 15.sp, textAlign = TextAlign.Center)
            Text( text = "10 Questions", fontSize = 14.sp, color = MaterialTheme.colorScheme.onSurfaceVariant)
            Spacer(modifier = Modifier.height(20.dp))
            Button(onClick = onStartActivity, modifier = Modifier.fillMaxWidth()) { Text("Start Practice") }
        }
